...
class ReviewService
{
    ...
    {
        if ((UserDefaults.standard.integer(forKey: "NumberReviews") <= 2) && (UserDefaults.standard.integer(forKey: "MagnetHockeyGames") >= 3) && (UserDefaults.standard.string(forKey: "EnjoyedApp") != "No"))
        {
            if lastRequest == nil
            {
                return true
